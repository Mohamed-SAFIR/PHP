        ...
        <tbody>
            ...
            <?php foreach ($parcours as $ligneParcours) : 
                ...
                <tr>
                    ...
                    <?php endforeach; ?>
                    <td><a href="singledesc.php?id=<?php echo $ligneParcours['id'];?>"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
